    ...
    <div className="mx-auto grid max-w-5xl gap-10 rounded-[40px] border border-white/10 bg-black/30 p-8 backdrop-blur-md md:grid-cols-2">
      <div className="flex flex-col gap-6 rounded-3xl bg-gradient-to-br from-primary/30 via-primary/10 to-transparent p-6">
        <div className="flex items-center gap-3 text-primary-light">
          ...
          <span className="text-xl font-semibold text-white">Espace Partenaire Mapéro</span>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-black/30 p-5 text-sm text-white/70">
          <p className="text-xs uppercase tracking-widest text-white/50">Pourquoi Mapéro ?</p>
      ...
      <div className="rounded-3xl border border-white/10 bg-black/50 p-6">
        <div className="mb-6 space-y-2">
          <h1 className="text-2xl font-semibold text-white">Connexion partenaire</h1>
