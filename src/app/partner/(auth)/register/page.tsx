...
export default function PartnerRegisterPage() {
  return (
    <div className="mx-auto grid max-w-5xl gap-10 rounded-[40px] border border-white/10 bg-black/30 p-8 backdrop-blur-md md:grid-cols-2">
      <div className="rounded-3xl border border-dashed border-white/20 bg-black/30 p-6">
        <Link
          href="/partner/login"
        ...
        <div className="mt-8 flex flex-col gap-4">
          <div className="flex items-center gap-3 text-accent">
            ...
            <span className="text-lg font-semibold text-white">Boostez vos apéros</span>
          </div>
          ...
          <div className="rounded-3xl bg-white/5 p-5 text-sm text-white/70">
            <p className="text-xs uppercase tracking-widest text-white/50">Ce qu’on met à votre dispo</p>
      ...
      <div className="rounded-3xl border border-white/10 bg-black/50 p-6">
        <div className="mb-6 space-y-2">
          <h1 className="text-2xl font-semibold text-white">Créer mon espace partenaire</h1>
